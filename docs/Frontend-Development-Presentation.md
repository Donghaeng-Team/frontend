...
1. [프로젝트 개요](#1-프로젝트-개요)
2. [기술 스택](#2-기술-스택)
3. [Talk to Figma - 디자인 시스템 구축](#3-talk-to-figma---디자인-시스템-구축)
4. [핵심 기능 개발](#4-핵심-기능-개발)
5. [실시간 채팅 시스템](#5-실시간-채팅-시스템)
6. [Playwright MCP - E2E 테스트 자동화](#6-playwright-mcp---e2e-테스트-자동화)
7. [주요 트러블슈팅](#7-주요-트러블슈팅)
...
**"디자인부터 테스트까지, 체계적인 프론트엔드 개발 경험"**

1. **Talk to Figma**로 일관된 디자인 시스템 구축
2. **TypeScript**로 100% 타입 안정성 확보
3. **WebSocket**으로 실시간 채팅 구현
4. **Playwright MCP**로 E2E 테스트 자동화
5. **체계적인 트러블슈팅**으로 안정적인 서비스 완성
